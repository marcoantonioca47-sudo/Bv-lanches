...
(function(){
  var s=document.createElement('script');s.src='supabase-sync.js?v=3';s.defer=true;document.head.appendChild(s);
  var p=document.createElement('script');p.src='supabase-profile.js?v=1';p.defer=true;document.head.appendChild(p);
})();
