...
(()=>{ 
  ...
  window.BV_STABILITY_VERSION='2026.09.24.3';
  ...
  window.BV_REFRESH_ORDERS=async()=>{
    ...
    if(role==='motoboy')q=q.eq('motoboy_id',user.id);else if(role!=='administrador')q=q.eq('user_id',user.id);
