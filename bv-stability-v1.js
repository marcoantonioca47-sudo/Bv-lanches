...
(()=>{ 
  ...
  window.BV_STABILITY_VERSION='2026.09.24.6';
  ...
  window.BV_REFRESH_ORDERS=async()=>{
    ...
    window.renderAdmin();window.renderDashboard();window.renderTracking();
  };
