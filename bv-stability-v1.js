...
(()=>{ 
  ...
  window.setMenuCategory=(cat,b)=>{window.BV_MENU_CATEGORY=cat;document.querySelectorAll('#page-cardapio .menuCategoryTabs button').forEach(x=>x.classList.remove('active'));b?.classList.add('active');window.renderProducts()};b?.classList.add('active');window.BV_CAT=c;window.renderProducts()};
