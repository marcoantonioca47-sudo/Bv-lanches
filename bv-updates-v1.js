...
css();window.BV_ANALYTICS_PERIOD=window.BV_ANALYTICS_PERIOD||'30';document.addEventListener('DOMContentLoaded',()=>setTimeout(()=>renderAnalytics(true),250),{once:true});setInterval(()=>renderAnalytics(false),5000);
})();